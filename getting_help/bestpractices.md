...
1.  Smaller docker containers are better. Larger images take longer to
    transfer and load.
2.  Use our base images for complex programs that require additional
    configuration files other than the [Dockerfile]{.title-ref}.
